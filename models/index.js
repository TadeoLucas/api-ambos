...
const sequelizeDB = new Sequelize('mysql://root:R2wdkJHo7wzRhDIDsr9n@containers-us-west-119.railway.app:6992/railway');
...
const User = sequelizeDB.define('user', {
  ...
  type: {type: ENUM("dueño","admin", "bann", "guest"), defaultValue: "guest"}
});
