...
router.post('/init', async (req, res, next) => {
  try{
    const { id, name, price, size, description, picture, path, picture2, path2} = req.body;
    await SalesHistory.create({ id, name, price, size, description, picture, path, picture2, path2});
